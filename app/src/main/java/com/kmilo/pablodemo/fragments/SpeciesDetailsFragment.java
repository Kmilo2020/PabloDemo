...
public class SpeciesDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgDetalle = (ImageView) view.findViewById(R.id.imagenDetalleId);
        txtDescripcion = (TextView) view.findViewById(R.id.descripcionId);

        Bundle objetoEspecie = getArguments();
        Species miEspecie = null;
        if (objetoEspecie != null) {
            miEspecie = (Species) objetoEspecie.getSerializable("objeto");
            asignarInformacion(miEspecie);
        }

        return view;
    }

    public void asignarInformacion(Species miEspecie) {
        imgDetalle.setImageResource(miEspecie.getImagenDetalle());
        txtDescripcion.setText(miEspecie.getDescripcion());
    }
